...
public class IntList {
    ...
    public static IntList reverse (IntList A) {
      if (A == null) {
        ...
        IntList remainder = reverse(A.tail);
        return IntList.catenate(remainder, new IntList(A.head, null));
      }
    }
     ...
     */
     ...
     public static IntList catenate(IntList A, IntList B) {
         return dcatenate(clone(A), clone(B));
     }

     public static IntList clone(IntList L) {
        if (L == null) {
            return null;
        }
        else {
            return new IntList(L.head, clone(L.tail));
        }
     }
    /**
